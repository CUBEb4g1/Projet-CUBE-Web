...
<footer class="footer1">
    <div class="f1-topbar p-0">
        <div class="container">
            ...
            <div class="row">
                <!-- Column -->
                <div class="col-md-12">
                    <nav class="navbar navbar-expand-lg f1-nav p-0"><a class="navbar-brand d-block d-md-none"
                                                                       href="/">{{-- Warning, this is a trapped link ahah --}}</a>
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ft1"
                                aria-controls="ft1" aria-expanded="false" aria-label="Toggle navigation">
                            <i class="fas fa-bars"></i>
                        </button>
                        <div class="collapse navbar-collapse" id="ft1">
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item"><a class="nav-link text-dark text-uppercase"
                                                        href="{{ route('contact') }}"><i
                                            class="fas fa-envelope-open-text text-danger font-20 mr-2"></i>Contactez-nous
                                        !</a></li>
                            </ul>
                        </div>
                    </nav>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="/"><img src="{{ asset_cache('media/favicons/favicon.png') }}" width="90" height="90"
                                     alt="Ressources Relationnelles"/></a>
                    <p class="mt-3">Rejoignez-nous aussi sur mobile pour ne jamais perdre de vue vos nouveaux contacts
                        !</p>
                ...
                <div class="col-lg-6 col-md-12 m-t-5">
                    ...
                    <ul class="general-listing two-part with-arrow mt-2 list-inline">
                        <li><a href="#" class="text-decoration-none d-flex py-2 align-items-center"><i
                                    class="icon-arrow-right mr-1"></i> A propos</a></li>
                        <li><a href="#" class="text-decoration-none d-flex py-2 align-items-center"><i
                                    class="icon-arrow-right mr-1"></i> Confidentialite</a></li>
                        <li><a href="#" class="text-decoration-none d-flex py-2 align-items-center"><i
                                    class="icon-arrow-right mr-1"></i> Support</a></li>
                        <li><a href="#" class="text-decoration-none d-flex py-2 align-items-center"><i
                                    class="icon-arrow-right mr-1"></i> Jobs</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="f1-bottom-bar py-3">
        <div class="container">
            <div class="d-flex">
                <div class="my-2">© {{ now()->year }} <a href="https://phoenixia-prods.com" target="_blank"
                                                         class="link p-2">Phoenixia Productions</a> Tous droits
                    reserves.
                </div>
                <div class="links ml-auto my-2">
                    <a href="https://github.com/CUBEb4g1/Projet-CUBE-Web" target="_blank" class="link p-2"><i
